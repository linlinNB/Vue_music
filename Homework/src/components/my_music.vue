      ...
      <span class="voice-btn-style">
        <transition name="control-voice">
          <div v-if="this.show_control_voice === true" style="position: fixed;left: 88%; top: 86%;">
            <input type="range" min="0" max="10" step="1" value="5" v-on:change="change_song_voice" id="myvoice">
          </div>
        </transition>
        <button v-on:click="show_song_voice">声音</button>
      </span>
    </div>
